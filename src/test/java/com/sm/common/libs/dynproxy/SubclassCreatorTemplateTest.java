...
import com.sm.common.libs.dynproxy.invoke.NullInvoker;
import com.sm.common.libs.dynproxy.provider.ConstantProvider;
import com.sm.common.libs.dynproxy.sample.AbstractEcho;
import com.sm.common.libs.dynproxy.sample.Echo;
import com.sm.common.libs.dynproxy.sample.EchoImpl;

/**
 * SubclassCreatorTemplateTestCase
 * 
 * @author <a href="chenxu.xc@alibaba-inc.com">xc</a>
 * @version create on 2016年11月21日 下午4:41:58
 */
public abstract class SubclassCreatorTemplateTest extends CreatorTemplateTest {
  ...
  public void testDelegatorWithSuperclass() {
    Echo echo = factory.createDelegatorProxy(new ConstantProvider<EchoImpl>(new EchoImpl()),
        new Class[] {Echo.class, EchoImpl.class});
  ...
  public void testInterceptorEquals() {
    EqualsEcho echo = new EqualsEcho("text");
    Echo proxy1 = factory.createInterceptorProxy(echo, new NoOpMethodInterceptor(), new Class[] {EqualsEcho.class});
    Echo proxy2 = factory.createInterceptorProxy(echo, new NoOpMethodInterceptor(), new Class[] {EqualsEcho.class});
    assertEquals(proxy1, proxy1);
    assertFalse(proxy1.equals(proxy2));
    assertFalse(proxy2.equals(proxy1));
  }
  ...
  public void testInterceptorWithSuperclass() {
    Echo echo = factory.createInterceptorProxy(new EchoImpl(), new NoOpMethodInterceptor(),
        new Class[] {Echo.class, EchoImpl.class});
    assertTrue(echo instanceof EchoImpl);
  }
  ...
  public void testWithAbstractSuperclass() {
    Echo echo =
        factory.createDelegatorProxy(new ConstantProvider<EchoImpl>(new EchoImpl()), new Class[] {AbstractEcho.class});
