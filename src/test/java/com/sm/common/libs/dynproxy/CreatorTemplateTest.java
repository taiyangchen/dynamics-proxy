...
import com.sm.common.libs.dynproxy.provider.BeanProvider;
import com.sm.common.libs.dynproxy.provider.ConstantProvider;
import com.sm.common.libs.dynproxy.provider.SingletonProvider;
import com.sm.common.libs.dynproxy.sample.DuplicateEcho;
import com.sm.common.libs.dynproxy.sample.Echo;
import com.sm.common.libs.dynproxy.sample.EchoImpl;
import com.sm.common.libs.dynproxy.sample.SuffixInterceptor;

/**
 * CreatorTemplateTest
 * 
 * @author <a href="chenxu.xc@alibaba-inc.com">xc</a>
 * @version create on 2016年11月21日 下午4:41:36
 */
public abstract class CreatorTemplateTest extends AbstractTest {

  private static final Class<?>[] ECHO_ONLY = new Class[] {Echo.class};
  protected final ProxyCreator factory;
  private static final Class<?>[] COMPARABLE_ONLY = new Class[] {Comparable.class};

  protected CreatorTemplateTest() {
  ...
  public void testDelegatingProxyInterfaceOrder() {
    ...
    List<Class<?>> expected = new LinkedList<Class<?>>(Arrays.<Class<?>>asList(Echo.class, DuplicateEcho.class));
    List<Class<?>> actual = new LinkedList<Class<?>>(Arrays.asList(echo.getClass().getInterfaces()));
