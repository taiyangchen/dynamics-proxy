 ...
 * @version create on 2016年11月21日 下午3:52:22
 */
public class DefaultProxyCreator implements ProxyCreator {
  ...
  public <T> T createDelegatorProxy(ClassLoader classLoader, ObjectProvider<?> delegateProvider,
    ...
    @SuppressWarnings("unchecked")
    T result =
        (T) getCapableProxyCreator(proxyClasses).createDelegatorProxy(classLoader, delegateProvider, proxyClasses);
  ...
  public <T> T createInterceptorProxy(ClassLoader classLoader, Object target, Interceptor interceptor,
    ...
    @SuppressWarnings("unchecked")
    final T result =
        (T) getCapableProxyCreator(proxyClasses).createInterceptorProxy(classLoader, target, interceptor, proxyClasses);
